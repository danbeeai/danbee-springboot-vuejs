                        ...
                        <div class="frogue-bottom-persistent_menu-wrap" :style="frogueFaqWrapperStyle">
                          ...
                          <div class="frogue-search-wrap" v-show="!faqBtnActive && inputMessage">
                            <ul class="frogue-search-wrap-ul" v-show="faqListFilterByKeyword.length > 0">
                              <li v-for="(faqSearchResult, index) in faqListFilterByKeyword" :key="'faqSearchRes' + index" @click="sendFaqMessage(faqSearchResult)" v-html="faqSearchResultToHtml(faqSearchResult)"></li>
                            </ul>
                          </div>
                          <!-- 자주 묻는 질문(카테고리) -->
                          ...
                          <div class="frogue-menu-detail-wrap" v-show="faqBtnActive && faqPageActiveTab[1]">
                            ...
                            <div class="menu-list_cont">
                              <ul class="menu-list_cont-ul">
                                <li v-show="faqListFilterByCategory.length > 0" v-for="(faqSearchResult, index) in faqListFilterByCategory" :key="'faqSearchRes' + index" @click="sendFaqMessage(faqSearchResult)"> {{ faqSearchResult }}</li>
    ...
    *,
    ...
    .frogue-container {
        ...
        .frogue-bottom-persistent_menu-wrap {
          ...
          bottom: 88px;
          width: 100%;
          border-top: 1px solid $frogue-color-main;
          ...
          .frogue-menu-wrap {
            ...
            i {
              ...
              &:before {
                ...
                border-top: 6px solid $frogue-color-main;
              }
            }
            button {
              float: left;
              ...
              font-size: 1.2em;
              border-radius: 6px;
              border: 1px solid $frogue-color-main;
        ...
        .frogue-input-wrapper {
            ...
            .btn-menu {
              ...
              i {
                ...
                height: 12px;
                background: $frogue-color-button-bg;
                border: 2px solid $frogue-color-main;
                border-radius: 2px;
                margin: 0 1px 1px 0;
              }
              &.active {
