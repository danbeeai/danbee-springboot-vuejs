<template>
    <div id="frogue-container">
        <div class="frogue-chat" id="frogue-chat" :class="{ 'show' : frogueChatOpenFlag }">
            ...
            <chat-body
                v-bind:dataChatbot="frogueChatbotId"
                v-bind:dataChatbotname="frogueChatbotName"
                v-bind:dataUser="frogueUserId"
                v-bind:dataServicename="frogueServicename"
                v-bind:dataColor="frogueBg"
                v-bind:dataSubcolor="frogueSubBg"
                v-bind:dataIconurl="frogueIconImg"
                v-bind:dataLoadurl="frogueLoadurl"
            ></chat-body>
        </div>
        <div class="frogue-launcher" :class="{ 'active' : frogueChatOpenFlag }" id="frogue-launcher" v-show="frogueLauncherReadyFlag" @click="frogueBtnElementClick()">
            <div >
                ...
                <div class="frogue-launcher-open-icon" v-if="frogueIconImg != ''">
                    <img class="chatbot-icon-image" width="60px" height="60px" style="width:60px; height:60px;" :src="publicPath+frogueIconImg" alt="chatbotIconImage" >
                </div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        data() {
            return {
              ...
              frogueLoadurl: this.dataLoadurl || '',
